...
class Client_DamageLocation extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  Client_DamageLocation copyWith(
          void Function(Client_DamageLocation) updates) =>
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<BlobSrc>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'blobs',
        $pb.PbFieldType.PM,
        subBuilder: BlobSrc.create)
    ..m<$core.String, BlobSrc>(
        8,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'blobMap',
        entryClassName: 'Client.BlobMapEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.OM,
        valueCreator: BlobSrc.create,
        packageName: const $pb.PackageName('RSS'))
    ..hasRequiredFields = false;
...
enum BlobSrc_BlobType { image, video, notSet }
...
class BlobSrc extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  BlobSrc copyWith(void Function(BlobSrc) updates) =>
