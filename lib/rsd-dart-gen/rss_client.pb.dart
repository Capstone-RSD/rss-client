...
class Client_DamageLocation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Client.DamageLocation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RSS'), createEmptyInstance: create)
  ...
  factory Client_DamageLocation.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Client_DamageLocation.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  Client_DamageLocation clone() => Client_DamageLocation()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Client_DamageLocation copyWith(void Function(Client_DamageLocation) updates) => super.copyWith((message) => updates(message as Client_DamageLocation)) as Client_DamageLocation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Client_DamageLocation create() => Client_DamageLocation._();
  Client_DamageLocation createEmptyInstance() => create();
  static $pb.PbList<Client_DamageLocation> createRepeated() => $pb.PbList<Client_DamageLocation>();
  @$core.pragma('dart2js:noInline')
  static Client_DamageLocation getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Client_DamageLocation>(create);
  static Client_DamageLocation? _defaultInstance;
...
class Client extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(7)
  $core.List<BlobSrc> get blobs => $_getList(4);

  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(8)
  $core.Map<$core.String, BlobSrc> get blobMap => $_getMap(5);
}
